...
class BookInit {
    ...
    let list: [Book] = [
        ...
        Book(title: "가정교사 히트맨 리본", price: 200, image: .가히리, category: "Romance"),
        Book(title: "강철의 연금술사", price: 230, image: .강연, category: "Romance"),
        Book(title: "격기 3반", price: 100, image: .격기3반, category: "Action"),
        Book(title: "데스노트", price: 290, image: .데스노트, category: "Horror"),
        Book(title: "아픈 건 싫으니까 방어력에 올인하려고 합니다", price: 200, image: .방어력만, category: "Romance"),
        Book(title: "베르세르크", price: 260, image: .베르세르크, category: "Horror"),
        Book(title: "무적코털 보보보", price: 300, image: .보보보, category: "Romance"),
        Book(title: "스파이 패밀리", price: 160, image: .스파이패밀리, category: "Romance"),
        Book(title: "에반 게리온", price: 300, image: .에반게리온, category: "Horror"),
        Book(title: "원펀맨", price: 350, image: .원펀맨, category: "Action"),
        Book(title: "전생했더니 슬라임이었던 건에 대하여", price: 370, image: .전생슬라임, category: "Action"),
        Book(title: "죠죠의 기묘한 모험", price: 220, image: .죠죠, category: "Horror"),
        Book(title: "최애의 아이", price: 290, image: .최애, category: "Romance"),
        Book(title: "클레이 모어", price: 300, image: .클레이모어, category: "Horror"),
        Book(title: "혈계전선", price: 350, image: .혈계전선, category: "Action"),
        Book(title: "호리미야", price: 370, image: .호리미야, category: "Romance"),
        Book(title: "카이지", price: 190, image: .카이지, category: "Horror")
    ]
